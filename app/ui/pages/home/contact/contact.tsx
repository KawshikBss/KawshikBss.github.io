...
function Contact({}: Props) {
    return (
        <div className="w-full flex flex-col items-center gap-20 py-20">
            <span className="text-[#14e956] font-black text-4xl uppercase transform skew-y-6">
                Connect With Me
            </span>
            <form className="w-3/5 flex flex-col gap-10">
                ...
                <button
                    type="submit"
                    className="w-fit self-center bg-[#14e956] hover:bg-[#12141d] py-3 px-8 rounded-lg text-lg text-[#12141d] hover:text-[#14e956] font-black shadow-2xl shadow-[rgba(20,233,86,.74)] transition-all duration-300 ease-in-out"
                >
                    Send Message
                </button>
            </form>

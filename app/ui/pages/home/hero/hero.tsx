...
function Hero({}: Props) {
    return (
        <div className="w-full bg-[url('/hero-bg.jpg')] bg-cover bg-center">
            <div className="w-full bg-black/70 flex flex-col-reverse md:flex-row justify-between items-center gap-5 md:gap-0 px-10 md:px-20 pt-16 md:pt-32 pb-4 md:pb-8">
                <div className="w-full md:w-2/5 flex flex-col items-start gap-7">
